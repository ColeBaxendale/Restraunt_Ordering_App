...
router.get('/restaurants/:name', verifyToken, isAdmin, adminRestaurantController.getRestaurantName);
router.put('/restaurants/:name', verifyToken, isAdmin, adminRestaurantController.updateRestaurant);
